...
exports.createLivre = async (req, res) => {
    ...
    try {
        ...
        let imageLivre;
        if (id_image) {
            imageLivre = await Image.findByPk(id_image, {
                transaction
            });
        }
        if (!imageLivre) {
            imageLivre = await Image.create(
                {
        ...
        // on vérifie si le personnage est défini
        if (!personnage) {
            res.status(400).json({message: "Personnage not found"});
            return;
        }
        ...
        if (!personnageImages) {
            personnageImages = await Image.create(
                {
                    image: "https://picsum.photos/270/500",
                },
                {transaction},
        ...
        // on créer le personnages par défaut
        ...
        let imageArme = await Image.findOne({
            where: {
                image:
        ...
        if (!imageArme) {
            imageArme = await Image.create({
                image: "data:imageLivre/png;base64,",
            }, {transaction});
        }
